...
# CSVファイルを読み込む
df = pd.read_csv('simulation-rk4_output_1(b).csv')
...
vmin = vmax - 20       # 最大値から50dB下までを色の範囲とする.9/19時点30
...
plt.savefig('sonogram-rk4_1(b).png') 
print("グラフを sonogram-rk4_1(b).png という名前で保存しました。")