...
# ソノグラムを計算してプロット
f, t, Sxx = spectrogram(pi, fs=sampling_rate, nperseg=8192, noverlap=6144) #もともと2048，1536　→　4096,3072 →　8192,6144
...
vmin = vmax - 32       # 最大値から50dB下までを色の範囲とする.9/19時点30 9/22時点18
