...
OUTPUT_CSV_FILE = "complexity_data_linked_eps*0.6.csv"       # 数値データの保存名
OUTPUT_3D_IMAGE = "complexity_3d_optimized_linked_eps*0.6.png"   # 画像の保存名
...
for folder in INPUT_FOLDERS:
    ...
    for i, csv_filepath in enumerate(csv_files):
        ...
        # raw_epsR = float(match.group(2)) # epsR は group(2) だが、今回は軸に使わないので無視
