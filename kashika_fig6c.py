...
# CSVファイルを読み込む
df = pd.read_csv('simulation-rk4_output_2(c).csv')
...
# ソノグラムを計算してプロット
f, t, Sxx = spectrogram(pi, fs=sampling_rate, window='blackmanharris', nperseg=81920, noverlap=61440) #2(a)は245760　184320
...
plt.title('Spectrogram of Simulated Birdsong (pi) Fig.6(c)')
#plt.colorbar(label='Intensity [dB]')
plt.savefig('sonogram-rk4_2(c).png') 
print("グラフを sonogram-rk4_2(c).png という名前で保存しました。")